...
public class ExpertReviews extends AppCompatActivity{
    GetIndividualRatings.RatingsObtained ratingsObtained;
    ...
    protected void onResume() {
        super.onResume();
        if (expert_identity != null){  try{ new GetIndividualRatings().execute(expert_identity); }catch (Exception e){e.printStackTrace();}}
    }
